...
import { DateRage } from "page-components/StaySearchForm/StaySearchForm";
import { FC } from "react";
import useWindowSize from "hooks/useWindowResize";
import { onChangeDate } from "state/action-creators";
...
const DateRange: FC<DateRangeProps> = ({
  ...
  // useEffect(() => {
  //   if(localStorage.hotelDateMomentStart || localStorage.hotelDateMomentEnd) {
  //     let date = {
  //       startDate: JSON.parse(localStorage.getItem("hotelDateMomentStart") || ''),
  //       endDate: JSON.parse(localStorage.getItem("hotelDateMomentEnd") || '')
  //     }
  //     console.log('dateLocalStorage: ', date)
  //     setStateDate(date)
  //   }
  //   else {
